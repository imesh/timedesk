...
privileged aspect FeedbackController_Roo_Controller {
    ...
    public String FeedbackController.show(@PathVariable("id") Long id, Model model) {
    ...
    public String FeedbackController.updateForm(@PathVariable("id") Long id, Model model) {
        model.addAttribute("feedback", Feedback.findFeedback(id));
        return "feedbacks/update";
    }
    
    @RequestMapping(value = "/{id}", method = RequestMethod.DELETE)
    public String FeedbackController.delete(@PathVariable("id") Long id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model model) {
