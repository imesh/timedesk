==================================================================
                   Time Desk Prototype 1.0
==================================================================

Welcome to the Time Desk Prototype 1.0 release.

Time Desk is a web based project resource management system developed using
...
7. Go in to source\timedesk directory.
8. Run the command mvn tomcat:run. 
   This will build and deploy the web application in a local tomcat 
   server instance.
9. Now open a web browser and go to URL http://localhost:8080/timedesk.
10. Login using username:admin and password:admin.
