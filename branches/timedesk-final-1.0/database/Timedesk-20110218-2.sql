...
INSERT INTO `em_role` VALUES (202,'Software Engineer','SE',1),(204,'Quality Assurance Engineer','QAE',1),(205,'Senior Quality Assurance Engineer','SQAE',1),(1152,'Senior Software Engineer','SSE',1);
...
INSERT INTO `user` VALUES (1,1,'admin','admin',2),(2,1,'imesh','imesh',3),(3,1,'chamil','chamil',2),(4,1,'channa','channa',3),(5,1,'thilina','thilina',3),(6,1,'eranga','eranga',2),(7,1,'nilupulee','nilupulee',2),(8,1,'resourcemanager','resourcemanager',2),(9,1,'projectmanager','projectmanager',2);
...
INSERT INTO `employee_em_role` VALUES (103,202),(1951,205);
...
INSERT INTO `project_member_pm_role` VALUES (1801,1753);
...
INSERT INTO `employee_skill` VALUES (103,209),(103,210);
...
INSERT INTO `project_phase` VALUES (902,'2011-01-01 00:00:00','Prototype Development','2011-01-15 00:00:00','OCEAN_PH2',1,201),(1301,'2011-02-15 00:00:00','Second Stage','2011-02-19 00:00:00','OCEANPH1',1,201),(1302,'2011-02-14 00:00:00','Third Stage','2011-02-21 00:00:00','OCEANPH11',1,201),(1651,'2011-02-20 00:00:00','Evaluation Stage','2011-02-24 00:00:00','SKYPH1',1,351),(1702,'2011-02-14 00:00:00','Beta Testing','2011-02-18 00:00:00','SKYPH2',1,351),(1851,'2011-03-01 00:00:00','SOA Designing Phase','2011-03-30 00:00:00','IMAGINEPH1',1,1751),(1902,'2011-03-01 00:00:00','Fourth Stage','2011-02-21 00:00:00','OCEANPH2',1,201);
...
INSERT INTO `company_site` VALUES (102,'CMB','World Trade Center','Colombo','Sri_Lanka',1,101),(107,'KND','Kandy Road','Kandy','Sri_Lanka',1,101),(2002,'NY','New York','New York','United_States',1,2001);
...
INSERT INTO `user_security_role` VALUES (1,51),(2,51),(9,52),(8,53),(3,55),(4,55),(5,55),(6,55),(7,55);
...
CREATE TABLE `project_member` (
  ...
  CONSTRAINT `FK_project_member_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `employee` (`id`) ON DELETE NO ACTION,
  CONSTRAINT `FK_project_member_project_id` FOREIGN KEY (`project_id`) REFERENCES `project` (`id`) ON DELETE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `project_member` VALUES (214,'OCEANIM',3,103,201),(251,'OCEANCH',3,104,201),(1252,'OCEANCHN',1,106,201),(1602,'SKYIMGUCMB',1,103,351),(1605,'SKYCHDICMB',1,104,351),(1801,'IMAGINEIMGUCMB',1,103,1751);
...
INSERT INTO `employee` VALUES (103,'IMGUCMB','Gunaratne',NULL,'12345',100,'Sri_Lanka','',5,'','imesh@timedeskonline.com','','','Imesh','',102,2),(104,'CHDICMB','Disanayake',NULL,'45678',100,'Sri_Lanka','Colombo',2,'','chamil@timedeskonline.com','','','Chamil','',102,3),(105,'NL','Nathawitharana',NULL,'',100,'Sri_Lanka','Colombo',1,'','nilupulee@timedeskonline.com','','','Nilupulee','',102,7),(106,'CHN','Senavirathna',NULL,'',100,'Sri_Lanka','Kandy',1,'','channa@timedeskonline.com','','','Channa','',102,4),(1951,'ALPRCMB','Prost',NULL,'',100,'United_States','',1,'','alain@timedeskonline.com','','','Alain','',102,2);
...
-- Dump completed on 2011-02-18 14:36:33
