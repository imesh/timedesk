				...
				<TR>
					<TD class=content style="PADDING-RIGHT: 10px; PADDING-LEFT: 10px; PADDING-BOTTOM: 10px; PADDING-TOP: 10px" >
						...
						<p><a href="<%= request.getContextPath( ) + "/frameset?__report=test.rptdesign&sample=my+parameter" %>">View Example</a>
                                                <p><a href="<%= request.getContextPath( ) + "/frameset?__report=report/project_com_site_report.rptdesign" %>">View Company Site_report</a>
                                                <p><a href="<%= request.getContextPath( ) + "/frameset?__report=report/project_employee_report.rptdesign" %>">View Employee Report</a>
					</TD>
				</TR>
			</TBODY>
		</TABLE>
