...
public class ProjectMemberController {
    ...
    public String create(@Valid ProjectMember projectMember, BindingResult result, Model model, HttpServletRequest request) {
        ...
        if (memberId != null) projectMember.setMemberId(memberId); else {
        ...
        sendMessage("noreply@timedeskonline.com", "TimeDeskOnline Notification: Project - "+projectMember.getProject().getName(), projectMember.getEmployee().getEmail(), "You have been assigned to "+projectMember.getProject().getName()+" Project From "+new Date());
    ...
    public String createForm(Model model, @RequestParam(value = "parentId", required = false) Long parentId) {
        ...
        if (parentId != null) {
            ...
            if (project != null) member.setProject(project);
        }
    ...
    private String generateMemberId(ProjectMember member) {
        if (member != null) {
            ...
            if (member.getEmployee() != null) memberKey = memberId += member.getEmployee().getEmployeeId().toUpperCase(); else {
