...
privileged aspect ProjectIntegrationTest_Roo_IntegrationTest {
    ...
    public void ProjectIntegrationTest.testCountProjects() {
        ...
        long count = org.timedesk.entity.Project.countProjects();
    ...
    public void ProjectIntegrationTest.testFindProject() {
        org.timedesk.entity.Project obj = dod.getRandomProject();
        ...
        obj = org.timedesk.entity.Project.findProject(id);
    ...
    public void ProjectIntegrationTest.testFindAllProjects() {
        ...
        java.util.List<org.timedesk.entity.Project> result = org.timedesk.entity.Project.findAllProjects();
    ...
    public void ProjectIntegrationTest.testFindProjectEntries() {
        ...
        java.util.List<org.timedesk.entity.Project> result = org.timedesk.entity.Project.findProjectEntries(0, (int) count);
    ...
    public void ProjectIntegrationTest.testMerge() {
        ...
        boolean modified =  dod.modifyProject(obj);
        java.lang.Integer currentVersion = obj.getVersion();
        org.timedesk.entity.Project merged = (org.timedesk.entity.Project) obj.merge();
        obj.flush();
    ...
    public void ProjectIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'Project' failed to initialize correctly", dod.getRandomProject());
        org.timedesk.entity.Project obj = dod.getNewTransientProject(Integer.MAX_VALUE);
    ...
    public void ProjectIntegrationTest.testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'Project' with identifier '" + id + "'", org.timedesk.entity.Project.findProject(id));
    }
